...
exports.generateAuthorizationPDF = generateAuthorizationPDF;
const jspdf_1 = require("jspdf");
function generateAuthorizationPDF(data) {
    const doc = new jspdf_1.jsPDF({ orientation: 'portrait', format: 'a5' });
